...
public class VLobby implements ILobbyView {
    ...
    private final VariantCheckBox vntGrinder = new VariantCheckBox(GameType.GRINDER); // Added for Grinder format
    private final ImmutableList<VariantCheckBox> vntBoxesLocal  =
            ImmutableList.of(vntVanguard, vntMomirBasic, vntMoJhoSto, vntCommander, vntOathbreaker, vntBrawl, vntTinyLeaders, vntPlanechase, vntArchenemy, vntArchenemyRumble, vntGrinder); // Added Grinder
